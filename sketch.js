...
function setup() {
   playGround = createCanvas(800, 300);
 ...
 console.log(message)
  ...
  ground = createSprite(camera.position.x,300,400,20);
...
function spawnClouds() {
  ...
  if (frameCount % 300 === 0) {
    var cloud = createSprite(playGround.width+100,120,40,10);
